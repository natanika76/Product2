...
public class DoctorController {
    ...
    public ResponseEntity<DoctorDTO> createDoctor(@RequestBody DoctorDTO doctorDTO) {
        ...
        doctorEventProducer.sendDoctorCreatedEvent(createdDoctor); // Отправляем событие
    ...
    public ResponseEntity<Void> deleteDoctor(@PathVariable Long id) {
        ...
        doctorEventProducer.sendDoctorDeletedEvent(id); // Отправляем событие удаления
    ...
    public ResponseEntity<DoctorDTO> updateDoctor(
        ...
        doctorEventProducer.sendDoctorUpdatedEvent(updatedDoctor); // Отправляем событие обновления
