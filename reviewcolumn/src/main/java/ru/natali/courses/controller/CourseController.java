...
public class CourseController {
    ...
    //GET http://localhost:8081/api/courses/statistics
    @GetMapping("/statistics")
    public List<Map<String, Object>> getCourseStatistics() {
        return courseService.getCourseStatisticsReport();
    }

    //GET http://localhost:8081/api/courses/empty-assignments
    ...
    //GET http://localhost:8081/api/courses/by-month
    @GetMapping("/by-month")
    public Map<String, Long> getCoursesByMonth() {
        return courseService.getCoursesByMonthReport();
    }

    //GET http://localhost:8081/api/courses/full-report
    ...
    //GET http://localhost:8081/api/courses/1/last-name-distribution
...
POST http://localhost:8081/api/courses/students
{
  "name": "Ivan",
  "lastName": "Bunin"
}
...
GET http://localhost:8081/api/courses/2/students-by-last-name-starts-with/Б
GET http://localhost:8081/api/courses/2/students-by-last-name-starts-with/%D0%91
 */