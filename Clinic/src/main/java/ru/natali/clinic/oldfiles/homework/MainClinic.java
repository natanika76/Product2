package ru.natali.clinic.oldfiles.homework;
...
/*
        ...
        //Все пациенты доктора
        System.out.println("Все пациенты доктора: ");
        System.out.println(patientRepository.findPatientsByDoctorId(8L));
