...
import ru.natali.clinic.repository.MedicalRecordsRepository;
...
public class MedicalRecordsRepositoryJdbcTemplateImpl implements MedicalRecordsRepository {
    ...
    private final String SQL_DELETE_RECORD_BY_ID = """
            ...
            """;
    private final String SQL_DELETE_ALL_MEDICAL_RECORDS = "DELETE FROM medical_records";
    ...
    public void deleteAll() {
        try {
            jdbcTemplate.update(SQL_DELETE_ALL_MEDICAL_RECORDS);
        } catch (Exception e) {
            throw new RuntimeException("Не удалось удалить все медицинские записи: " + e.getMessage(), e);
        }
    }
}
