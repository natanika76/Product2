...
public class AppointmentRepositoryJdbcTemplateImpl implements AppointmentRepository {
    ...
    private final String SQL_MISSED_APPOINTMENTS = """
            ...
            """;
    private final String SQL_DELETE_ALL_APPOINTMENTS = "DELETE FROM appointments";
    ...
    public void deleteAll() {
        try {
            jdbcTemplate.update(SQL_DELETE_ALL_APPOINTMENTS);
        } catch (Exception e) {
            throw new RuntimeException("Не удалось удалить все записи: " + e.getMessage(), e);
        }
    }
