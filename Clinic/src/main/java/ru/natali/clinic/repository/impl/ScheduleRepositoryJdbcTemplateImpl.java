...
import ru.natali.clinic.repository.ScheduleRepository;
...
public class ScheduleRepositoryJdbcTemplateImpl implements ScheduleRepository {
    ...
    private final String SQL_DELETE_SCHEDULE_BY_ID = """
            ...
            """;
    private final String SQL_DELETE_ALL_SCHEDULES = "DELETE FROM schedules";
    ...
    public void deleteAll() {
        try {
            jdbcTemplate.update(SQL_DELETE_ALL_SCHEDULES);
        } catch (Exception e) {
            throw new RuntimeException("Не удалось удалить все записи расписания: " + e.getMessage(), e);
        }
    }
