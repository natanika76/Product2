...
import ru.natali.clinic.exception.patientexception.PatientDeletionException;
import ru.natali.clinic.exception.patientexception.PatientNotFoundException;
import ru.natali.clinic.exception.patientexception.PatientSaveOrUpdateException;
...
public class PatientRepositoryJdbcTemplateImpl implements PatientRepository {
    ...
    private final String SQL_PATIENTS_BIRTHDAY_TODAY =
           ...
           """;
    private final String SQL_DELETE_ALL_PATIENTS = "DELETE FROM patients";
    ...
    public List<Patient> findAll() {
        try {
            ...
            throw new ClinicException("Ошибка в SQL-запросе: таблица patients не существует", e);
        } catch (DataAccessException e) {
            throw new ClinicException("Ошибка при выполнении запроса к базе данных", e);
        }
    }
    ...
    public void deleteAll() {
        try {
            jdbcTemplate.update(SQL_DELETE_ALL_PATIENTS);
        } catch (BadSqlGrammarException e) {
            throw new ClinicException("Ошибка в SQL-запросе: таблица patients не существует", e);
        } catch (DataAccessException e) {
            throw new ClinicException("Ошибка при удалении пациентов", e);
        }
    }
    ...
    public Optional<Patient> find(Long id) {
        try {
            ...
            throw new PatientNotFoundException("Пациент с id=" + id + " не найден", e);
        }
    }
    ...
    public void save(Patient patient) {
        try {
            ...
            throw new PatientSaveOrUpdateException("Не удалось сохранить пациента: " + e.getMessage(), e);
        }
    }
    ...
    public void update(Patient patient) {
        try {
            ...
            throw new PatientSaveOrUpdateException("Не удалось обновить пациента: " + e.getMessage(), e);
        }
    }
    ...
    public Patient updatePatient(Long id, String newFirstName, String newLastName) {
        ...
        if (optionalPatient.isPresent()) {
            ...
            throw new PatientNotFoundException("Пациент с id=" + id + " не найден");
        }
    }
