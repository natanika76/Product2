...
VALUES ('Иван', 'Попов', '1985-05-15', '+1234567890', 'ivan.popov@example.com', 'Липецк, пр.Мира, д.31 кв.15'),
       ...
       ('Павел', 'Морозов', '1995-05-09', '+3698521204', 'pavel.morozov@example.com',
        'Липецк, Сиреневый пр., д.120 кв.50'),
       ('Полина', 'Морозова', '2003-12-20', '+1123469014', 'polina.morozova@example.com',
        'Липецк, Сиреневый пр., д.120 кв.50')
...
VALUES ('Общий осмотр', 'Обычный медицинский осмотр.', 500.00),
       ...
       ('Измерение температуры', 'Измерение температуры.', 200.00)
ON CONFLICT DO NOTHING;
